...
class PolishSearchSettings:
    ...
    use_custom_sampling_operator: bool
    use_custom_mutation_operator: bool
    use_custom_crossover_operator: bool

    use_custom_atomicity: bool
    genome_threshold: Optional[int]

    include_ps_len: bool
    include_sample_quantity: bool
    include_wasserstein_distance: bool
    include_diff_median: bool
    include_atomicity: bool

    include_p_value: bool
    include_mean_fitness: bool
...
def search_for_pss_using_genome_threshold(session_data: PRef,
                                          optimised_session_data: OptimisedSPref,
                                          search_settings: PolishSearchSettings) -> list[EvaluatedNCSolution]:

    n = session_data.search_space.amount_of_parameters
    ...
    custom_sampling = NCSamplerFromPRef.from_PRef(session_data)
    ...
    algorithm = NSGAIICustom(sampling=custom_sampling if search_settings.use_custom_sampling_operator else traditional_sampling,
                             ...
                             crossover=custom_mutation if search_settings.use_custom_mutation_operator else traditional_crossover,
