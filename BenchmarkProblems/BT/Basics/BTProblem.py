...
import utils
from BenchmarkProblems.BT.Basics.ReadFromFiles import get_dicts_from_RPD, make_roster_patterns_from_RPD, get_dicts_from_ED, \
    make_employees_from_ED, get_skills_dict
from BenchmarkProblems.BT.Basics.RotaPattern import get_workers_present_each_day_of_the_week, get_range_scores
from BenchmarkProblems.BT.Basics.Worker import Worker, WorkerVariables, Skill
from BenchmarkProblems.BenchmarkProblem import BenchmarkProblem
from Core.FullSolution import FullSolution
from Core.PS import PS, STAR
from Core.SearchSpace import SearchSpace
from data.BT.names import names
...
class BTProblem(BenchmarkProblem):
    ...
    def from_default_files(cls):
        root = r"C:\Users\gac8\PycharmProjects\PSSearch\data\BT\MartinsInstance"
